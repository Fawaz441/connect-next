...
import mobfootBus from "../assets/images/frame29.png";
    ...
    <>
      <section className="intro">
        <div className="container">
          <h1>Roadmap</h1>
          <p>
            Our planned Roadmap, a step-by-step development strategy, is
            discussed below :
          </p>
        </div>
      </section>
          ...
          <ul>
            <li>
              <div className="timeline-content">
                ...
                <p>
                  The first stage will concentrate on developing and releasing
                  the Ambitchous ecosystem's official website. The website will
                  act as an ecosystem and marketplace, allowing users and token
                  holders to acquire native tokens, exchange unique tokens, and
                  engage in the ecosystem, among other things.
                </p>
              </div>
            </li>
            <li>
              <div className="timeline-content">
                ...
                <p>
                  The focus of the next stage will be on releasing and
                  publicizing project documentation. This document provides all
                  of the pertinent information regarding the project.
                </p>
              </div>
            </li>
            <li>
            ...
            <li>
              <div className="timeline-content">
                ...
                <p>
                  To raise awareness of the environment, intensive marketing
                  will be carried out. We'll use a variety of marketing
                  techniques, including airdrops, social media marketing.
                </p>
              </div>
            </li>
            <li>
