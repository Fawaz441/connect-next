        ...
        <div className="container grid">
          <div className="about-us-text">
            ...
            <p>
              ...
              platform with the best user experience possible. Ambitchous Token
              is a next-generation decentralized NFT for all market sectors
              dedicated to the growing world of digital artists, designers, and
              collectors.
            </p>
          </div>
        ...
        <div className="container grid">
          ...
          <div className="mission-text">
            ...
            <p>
              ...
              without fear of anyone stealing your idea! Our ecosystem
              encourages people to have fun and be creative during the new wave
              of NFTs.
            </p>
          </div>
        </div>
        ...
        <div className="desktop">
          ...
          <div className="button">
            <Link href="how-to-buy">
              <div className="btn">Buy Presale</div>
            </Link>
          </div>
        </div>
